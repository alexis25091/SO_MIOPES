...
// FunciC3n para simular la carga de una pC!gina a memoria fC-sica
void loadPage(FrameList *frameList, int page) {
	Frame *frame = createFrame();
	frame->page = page;
	frame->valid = true;

	// Si la lista de frames ya estC! llena, reemplazar la pC!gina menos recientemente usada (LRU)
